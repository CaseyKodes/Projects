...
void ASSERT_EQ(T x, T y)
{
  ...
  {
    cout << "\t\t\tFAILED: GIVEN-" << x << " DOES NOT EQUAL EXPECTED-" << y << endl;
  }
}
...
static void Test6()
{
    ...
    cout << "now use larger memory: 7 pages\n";
