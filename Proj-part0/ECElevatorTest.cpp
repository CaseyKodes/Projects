...
// currently not gonig to execute
        #if 0
            if( tmDone >= 0 )
            {
...
// (iv) at time 8 arrives at floor 5 to unload passenger 2 (passenger 2 arrives at time 8) and moving downwards at time 9 
// (note: passenger 3 is not ready to go yet)
...
// the last auto grader that wont pass
static void Test5()
{
    cout << "\n****** TEST 5\n";
    // test setup
    ...
    ECElevatorSimRequest r1(1, 3, 1), r2(2, 3, 2), r3(10, 2, 3), r4(14, 2, 1), r5(20, 3, 2);
    vector<ECElevatorSimRequest> listRequests;
    listRequests.push_back(r1);
    listRequests.push_back(r2);
    listRequests.push_back(r3);
    ...
    vector<int> listArriveTime;
    listArriveTime.push_back(7);
    listArriveTime.push_back(5);
    listArriveTime.push_back(13);
    listArriveTime.push_back(17);
    listArriveTime.push_back(24); 
...
static void Test6()
{
    ...
    const int timeSim = 100;
    ECElevatorSimRequest r1(1,8,1), r2(2,9,1);
    vector<ECElevatorSimRequest> listRequests;
    listRequests.push_back(r1);
    listRequests.push_back(r2);

    vector<int> listArriveTime;
    listArriveTime.push_back(0);
    listArriveTime.push_back(0);
